...
- Supersedes: none
- Superseded by: [ADR 0035](0035-use-django-polled-yandex-disk-import.md) only for background control
  and transfer of public Yandex Disk imports; local browser uploads retain this decision.
