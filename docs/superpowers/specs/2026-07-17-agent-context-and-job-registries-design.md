...
Repository contract tests whose sole subject is Markdown content or existence will be removed. This
includes assertions over `AGENTS.md`, architecture and planning documents, ADR templates and indexes,
project `SKILL.md` files, and Markdown inventories.
