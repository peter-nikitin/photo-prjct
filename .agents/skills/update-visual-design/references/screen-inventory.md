...
| Upload | design-reference | `tests/visual/templates/design_reference/upload.html` | none | `/__visual__/reference/upload/` | `desktop-reference-upload.png`, `mobile-reference-upload.png` |
