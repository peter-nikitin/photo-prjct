...
Draft for written review. The product design was approved in conversation on 2026-08-25; this
artifact still requires maintainer review before an ADR or implementation plan is written.
...
- ADR impact: **Requires a new ADR.** Streaming an aggregate archive body through Django is a
  ...
  stored archive and background archive job are not selected. Planning must not begin until that
  ADR is accepted.
