...
| Checkout | production | `src/backend/templates/commerce/checkout.html` | `/events/<slug>/cart/checkout/` | none (Task 9) | none (Task 9) |
| Order | production | `src/backend/templates/commerce/order.html` | `/orders/<public-number>/`, `/orders/<public-number>/return/`, and the access-grant variant | none (Task 9) | none (Task 9) |
