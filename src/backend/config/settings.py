...
GALLERY_CDN_ORIGIN = env("GALLERY_CDN_ORIGIN", default="")
GALLERY_CDN_TOKEN_SECRET = env("GALLERY_CDN_TOKEN_SECRET", default="")
GALLERY_IMGPROXY_KEY = env("GALLERY_IMGPROXY_KEY", default="")
GALLERY_IMGPROXY_SALT = env("GALLERY_IMGPROXY_SALT", default="")
...
TBANK_TERMINAL_KEY = env("TBANK_TERMINAL_KEY", default="")
TBANK_TERMINAL_PASSWORD = env("TBANK_TERMINAL_PASSWORD", default="")
TBANK_API_ORIGIN = env("TBANK_API_ORIGIN", default="")
TBANK_RUB_ONLY = env.bool("TBANK_RUB_ONLY", default=None)
TBANK_PAY_TYPE = env("TBANK_PAY_TYPE", default="")
TBANK_RECEIPT_FFD = env("TBANK_RECEIPT_FFD", default="")
TBANK_RECEIPT_TAXATION = env("TBANK_RECEIPT_TAXATION", default="")
TBANK_RECEIPT_TAX = env("TBANK_RECEIPT_TAX", default="")
TBANK_RECEIPT_PAYMENT_METHOD = env("TBANK_RECEIPT_PAYMENT_METHOD", default="")
TBANK_RECEIPT_PAYMENT_OBJECT = env("TBANK_RECEIPT_PAYMENT_OBJECT", default="")
TBANK_RECEIPT_MEASUREMENT_UNIT = env("TBANK_RECEIPT_MEASUREMENT_UNIT", default="")
