...
visual_patterns = [
    ...
    path("workspace/photos/", views.event_photo_workspace, name="visual_event_photo_workspace"),
    path(
        "workspace/photos/filtered-empty/",
        views.event_photo_workspace_filtered_empty,
        name="visual_event_photo_workspace_filtered_empty",
    ),
    path(
        "workspace/photos/hidden/",
        views.event_photo_workspace_hidden,
        name="visual_event_photo_workspace_hidden",
    ),
    path(
        "workspace/photos/error/",
        views.event_photo_workspace_error,
        name="visual_event_photo_workspace_error",
    ),
    path(
        "workspace/interaction/",
        views.event_photo_workspace_interaction,
        name="visual_event_photo_workspace_interaction",
    ),
    path(
        "workspace/results/",
        views.event_photo_workspace_results,
        name="visual_event_photo_workspace_results",
    ),
    path(
        "workspace/folders/create/",
        views.event_photo_folder_create,
        name="visual_event_photo_folder_create",
    ),
    path("workspace/status-api/", views.event_photo_status_api, name="visual_event_photo_status"),
    path(
        "workspace/batch-history-api/",
        views.event_photo_batch_history_api,
        name="visual_event_photo_batch_history",
    ),
    path("upload/chooser/", views.upload_chooser, name="visual_upload_chooser"),
    ...
    path("upload/processing/", views.upload_processing, name="visual_upload_processing"),
